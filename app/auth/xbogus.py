# ==============================================================================
# X-Bogus 签名算法 (来自 jiji262/douyin-downloader)
# 原作者: Evil0ctal
# License: Apache 2.0
# ==============================================================================
...
class XBogus:
    ...
    def _encoding_conversion(self, *args) -> str:
        payload = [args[0]]
        payload.append(int(args[1]))
        payload.extend(args[2:])
